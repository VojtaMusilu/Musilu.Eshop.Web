...
namespace Musilu.Eshop.Web.Models.Validations
{
    ...
    public class FileContentValidationAttribute : ValidationAttribute, IClientModelValidator
    {
        ...
        protected override ValidationResult IsValid(object value, ValidationContext validationContext)
        {
            ...
            throw new NotImplementedException($"Attribute {nameof(FileContentValidationAttribute)} is not implemented for this type of object: {value.GetType()}");
        }
